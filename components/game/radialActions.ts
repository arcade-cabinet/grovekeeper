 ...
 */
const TREE_TOOL_ACTION: Partial<
  Record<string, { id: string; icon: string; label: string; color: string }>
> = {
...
const ACTION_INSPECT: RadialAction = {
  id: "inspect",
  icon: "\u{1F4D6}",
  label: "Inspect",
  color: "#90CAF9",
};
const ACTION_TALK: RadialAction = {
  id: "talk",
  icon: "\u{1F4AC}",
  label: "Talk",
  color: "#FFB74D",
};
const ACTION_TRADE: RadialAction = {
  id: "trade",
  icon: "\u{1F4B0}",
  label: "Trade",
  color: "#A5D6A7",
};
const ACTION_USE: RadialAction = {
  id: "use",
  icon: "\u{1F6E0}\uFE0F",
  label: "Use",
  color: "#CE93D8",
