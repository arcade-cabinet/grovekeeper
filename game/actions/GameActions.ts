 ...
 *
 * Extracts game actions into pure functions that operate on ECS world +
 * Zustand store without React, rendering engines, haptics, or toast UI.
 * Returns boolean success/failure for each action.
 *
 * Used by the PlayerGovernor for automated playtesting and E2E tests.
