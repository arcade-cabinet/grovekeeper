/**
 * World module barrel — re-exports the biome-aware world surface so other
 * modules can import from `@/game/world` without reaching into individual files.
 */
...
// Biome assigner + chunk streaming manager.
export {
...
// ChunkActor is the streaming-aware chunk; SingleChunkActor is a thin
// alias preserved for external callers.
...
// Grove placement, glow, discovery.
export {
...
// Starter grove pre-state seeding.
export {
